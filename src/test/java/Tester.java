...
public class Tester {
    ...
    // =========================================================================================================
    // ===============================Tests parallelization on the same graphs==================================
    // =========================================================================================================
     ...
     */
    @Test
    public void testOneProcessorEmptyGraphParallel() {
        SolutionValidator validator = new SolutionValidator();

        String inputFileName = graphDir + "EmptyGraph.dot";
        String outputFileName = inputFileName.replace(".dot", "-output.dot");
        assertTrue(testValidityParallel(validator, inputFileName, 1, outputFileName));
        assertEquals(0, validator.getBestTime());
        cleanUp(outputFileName);
    }
     ...
     */
    @Test
    public void testOneProcessorOneNodeParallel() {
        SolutionValidator validator = new SolutionValidator();
     ...
     */
    @Test
    public void testOneProcessorNoEdgesParallel() {
        SolutionValidator validator = new SolutionValidator();
     ...
     */
    @Test
    public void testOneProcessorSequentialEdgesParallel() {
        SolutionValidator validator = new SolutionValidator();
     ...
     */
    @Test
    public void testOneProcessorSevenEdgesParallel() {
        SolutionValidator validator = new SolutionValidator();
     ...
     */
    @Test
    public void testMultipleProcessorsEmptyGraphParallel() {
        SolutionValidator validator = new SolutionValidator();

        String inputFileName = graphDir + "EmptyGraph.dot";
        String outputFileName = inputFileName.replace(".dot", "-output.dot");
        assertTrue(testValidityParallel(validator, inputFileName, 4, outputFileName));
        assertEquals(0, validator.getBestTime());
        cleanUp(outputFileName);
    }
     ...
     */
    @Test
    public void testMultipleProcessorsOneNodeParallel() {
        SolutionValidator validator = new SolutionValidator();

        String inputFileName = graphDir + "1Node.dot";
        String outputFileName = inputFileName.replace(".dot", "-output.dot");
        assertTrue(testValidityParallel(validator, inputFileName, 2, outputFileName));
        assertEquals(21, validator.getBestTime());
        cleanUp(outputFileName);
    }
     ...
     */
    @Test
    public void testMultipleProcessorSequentialEdgesParallel() {
        SolutionValidator validator = new SolutionValidator();

        String inputFileName = graphDir + "5NodesSequentialEdges.dot";
        String outputFileName = inputFileName.replace(".dot", "-output.dot");
        assertTrue(testValidityParallel(validator, inputFileName, 3, outputFileName));
        assertEquals(154, validator.getBestTime());
        cleanUp(outputFileName);
    }
     ...
     */
    @Test
    public void testMultipleProcessorZeroEdgesParallel() {
        SolutionValidator validator = new SolutionValidator();
     ...
     */
    @Test
    public void testMultipleProcessorsMaximalEdgesParallel() {
        SolutionValidator validator = new SolutionValidator();
     ...
     */
    @Test
    public void testSparseGraphFifteenNodesParallel() {
        SolutionValidator validator = new SolutionValidator();
     ...
     */
    @Test
    public void testDenseGraphFifteenNodesParallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedSeven2Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedSeven4Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedEight2Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedEight4Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedNine2Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedNine4Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedTen2Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedTen4Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedEleven2Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    @Test
    public void testProvidedEleven4Parallel() {
        SolutionValidator validator = new SolutionValidator();
    ...
    private boolean testValidityParallel(SolutionValidator validator, String inputFileName, int numProcessors, String outputFileName) {
        try {
            Process process = Runtime.getRuntime().exec("java -jar scheduler.jar " +
                    inputFileName + " " + numProcessors + " -p 4" + " -o " + outputFileName);
            process.waitFor();
        } catch (Exception e) {
            System.err.println("Error waiting for scheduler to run programs");
            e.printStackTrace();
